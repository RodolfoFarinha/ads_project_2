...
namespace Api.Service.Interfaces.Services
{
    ...
    public interface IScheduleCalculatorService
    {
        ...
        /// <returns></returns>
        List<QualityScheduleViewModel> AllocateRoomsToSessions(Tuple<string[], List<string[]>> propertiesData, Tuple<string[], List<string[]>> roomsData, Tuple<string[], List<string[]>> sessionsData);
    }
}